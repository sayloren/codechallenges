...
# note:
# this is not that well written, i think - there are nested for loops and
# an uneccesqry function wrapping it
# though it initally looks less efficient, with the larger the number,
# doing inint(i/2)+1 - larger number the number, the more this way
# beomces computationally efficient
...
def check ():
    ...
    for candidate in range(1,200+1):
